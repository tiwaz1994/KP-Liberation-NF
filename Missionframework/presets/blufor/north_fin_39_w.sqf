...
heavy_vehicles = [
    ["NORTH_FIN_Vickers6t",225,275,200],
    ["NORTH_FIN_W_39_T26_M33_OT",275,125,225],
    ["NORTH_FIN_W_39_T26_M31",275,125,200],
    ["NORTH_FIN_W_39_T26_M33",275,125,200],
    ["NORTH_FIN_W_39_T26_M38",400,400,300],
    ["NORTH_FIN_W_39_T28",600,600,600]
];

air_vehicles = [
    ["sab_gladiator_fin",100,75,300],
    ["sab_i16_fin",100,75,300],
    ["LIB_C47_RAF_snafu",225,0,600],
    ["sab_tusb2",225,300,600]
];

static_vehicles = [
    ["NORTH_FIN_W_39_Maxim",10,5,0],
    ["NORTH_FIN_W_39_Maxim_High",10,5,0],
    ["NORTH_FIN_W_39_Maxim_Medium",10,5,0],
    ["LIB_61k",25,100,0],
    ["LIB_BM37",25,100,0],
    ["NORTH_FIN_W_39_76RK27",25,50,0],
    ["NORTH_FIN_W_39_37PSTK36",25,50,0],
    ["NORTH_FIN_W_39_45PSTK37",40,80,0],
    ["NORTH_FIN_W_39_50KRH38",40,100,0],
    ["NORTH_FIN_W_39_81KRH32",40,150,0],
    ["NORTH_FIN_W_39_76k02",40,200,0],
    ["NORTH_FIN_W_39_76k36",80,250,0],
    ["NORTH_FIN_W_39_152H38",100,1000,0],
    ["NORTH_FIN_W_41_Lahti_L39",200,100,0]
];
...
buildings = [
    ...
    ["Land_CUP_BagFenceShort_EP1_w",1,0,0],
    ["Land_CUP_BagFenceRound_w",1,0,0],
    ["Land_CUP_BagFenceEnd_EP1_w",1,0,0],
    ["Land_CUP_BagFenceCorner_w",1,0,0],
    ["Land_CUP_BagFenceLong_EP1_w",1,0,0],
    ...
    ["WW2_BET_Bwire_2",1,0,0],
    ["WW2_BET_Bwire_3",1,0,0],
    ["WW2_BET_Bwire_4",1,0,0],
    ["Land_WW2_Wire_1",1,0,0],
    ["Land_WW2_Wire_3",1,0,0],
    ["Land_WW2_Wire_2",1,0,0],
    ["Land_I44_Buildings_Wirefence",1,0,0],
    ["Wire",1,0,0],
    ["WireFence",1,0,0],
    ["Land_WW2_Fortification_Pillbox_Small_w",15,0,0],
    ...
    ["WW2_JNS_Fortified_Nest_Big",10,0,0],
...
support_vehicles = [
    ...
    [Respawn_truck_typename,350,0,75],
    ...
    ["WW2_Cle_Container",20,0,0],
    ["NORTH_Supplytorpedo",20,0,0],
